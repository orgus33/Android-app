...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        if (lemonadeState == SELECT) {
            val submitText = getResources().getString(R.string.lemon_select)
            textAction.text = submitText
            lemonImage?.setImageResource(R.drawable.lemon_tree)
        } else if (lemonadeState == SQUEEZE) {
            val submitText = getResources().getString(R.string.lemon_squeeze)
            textAction.text = submitText
            lemonImage?.setImageResource(R.drawable.lemon_squeeze)
        } else if (lemonadeState == DRINK) {
            val submitText = getResources().getString(R.string.lemon_drink)
            textAction.text = submitText
            lemonImage?.setImageResource(R.drawable.lemon_drink)
        } else if (lemonadeState == RESTART) {
            val submitText = getResources().getString(R.string.lemon_empty_glass)
            textAction.text = submitText
